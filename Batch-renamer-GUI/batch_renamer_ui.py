...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.RenameRadioButton = QtWidgets.QRadioButton(parent=self.groupBox)
        self.RenameRadioButton.setEnabled(True)
        self.RenameRadioButton.setObjectName("RenameRadioButton")
        self.horizontalLayout_4.addWidget(self.RenameRadioButton)
        self.CopyRadioButton = QtWidgets.QRadioButton(parent=self.groupBox)
        self.CopyRadioButton.setObjectName("CopyRadioButton")
        self.horizontalLayout_4.addWidget(self.CopyRadioButton)
