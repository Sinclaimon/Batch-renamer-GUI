...
class BatchRenamerWindow(QMainWindow, Ui_MainWindow):
    ...
    def add_tooltips(self):
        ...
        self.FilePathEdit.setToolTip(
            "Enter the file path or browse to select a folder")
        self.BrowseButton.setToolTip(
            "Browse to select a folder")
        self.FiletypesEdit.setToolTip(
            "Enter the file types to include (e.g., .txt, .png)")
        self.PrefixEdit.setToolTip(
            "Enter the prefix to add to file names")
        self.SufixEdit.setToolTip(
            "Enter the suffix to add to file names")
        self.StringsToFindEdit.setToolTip(
            "Enter the strings to find, separated by commas")
        self.StringsToReplaceEdit.setToolTip(
            "Enter the string to replace the found strings")
        self.CopyRadioButton.setToolTip(
            "Check to copy files instead of moving them")
        self.RenameRadioButton.setToolTip(
            "Check to rename files")
        self.RunButton.setToolTip(
            "Run the batch renamer")
    ...
    def run_renamer(self):
        ...
        try:
            ...
            self.logger.info(
                "Running batch renamer with the following parameters:")
            ...
            self.batch_renamer.rename_files_in_folder(filepath, 
                                                      filetypes, 
                                                      strings_to_find, 
                                                      string_to_replace, 
                                                      prefix, 
